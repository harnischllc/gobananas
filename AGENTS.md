...
Go Bananas (full name: "Go Bananas: Banana Scanner") is a native mobile app (iOS + Android) that scans bananas with the camera and classifies their ripeness stage using a custom hue-based classifier. Solo hobby project run under Harnisch LLC. BOTH stores are PUBLICLY LIVE on v1.0.0 (build 14), which carries banana facts, the SVG banana-mark branding across icon and splash, the anonymous corrections loop, and the You-tab lede fix. iOS is live on the App Store as of 2026-07-09 at https://apps.apple.com/us/app/id6772261640 (rechecked 2026-09-14 via Apple's lookup API; minimum iOS 15.1). The TestFlight groups still exist (Beta Bananas external group with a public join link, plus the internal Team Expo group). Android is live on Google Play as of 2026-07-07: production listing at https://play.google.com/store/apps/details?id=com.harnischllc.gobananas, versionCode 14 (Loggerhead Creative dev account). Detail in the Open questions section and Open Brain captures 717, 718, 1007, and 1046.
...
- The Render service that hosted the Flask backend is fully shut down as of 2026-05-24. The SessionEnd hook in `.claude/settings.json` that reminded about this was removed on 2026-08-27 (commit `05030bf`).
...
- App Store public release: DONE. Live on the App Store as of 2026-07-09 (v1.0, build 14) at https://apps.apple.com/us/app/id6772261640. The three old blockers (review-contact phone, 13-inch iPad screenshot, Content Rights) were cleared. App Privacy published (anonymous diagnostics, not linked, no tracking, Analytics + App Functionality), age 4+, category Food & Drink, Pricing Free across 175 regions, availability all countries.
- Play Store public release: DONE. Live in production as of 2026-07-07 (build 14) at https://play.google.com/store/apps/details?id=com.harnischllc.gobananas. Data safety declares the corrections loop (App activity > Other actions, optional, App functionality + Analytics, encrypted in transit, no deletion path).
